...
use Railken\Laravel\Core\Data\Manga\Manga;
use Railken\Laravel\Core\Data\Address\Address;
use Railken\Laravel\Core\Data\File\File;
...
class User extends Authenticatable implements EntityContract
{
    ...
    {
        return (new \Railken\Laravel\Core\Data\User\UserManager())->getRepository()->getQuery()->orWhere(function ($q) use ($identifier) {
