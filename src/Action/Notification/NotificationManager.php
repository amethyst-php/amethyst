...
class NotificationManager extends ModelManager
{
    ...
    {
        $user = (new \Railken\LaraOre\User\UserManager($this->getAgent()))->getRepository()->findOneById($event->user->id);
        $users = new Collection();

        $repository = (new \Railken\LaraOre\User\UserManager())->getRepository();
